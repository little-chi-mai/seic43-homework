...
//global variable - one way of doing all of this
const state = {
  nextPage: 1,
...
$(document).ready(function () {
  ...
  const chillSearchFlickr = _.debounce(searchFlickr, 4000, true);// all you need to prevent making additional requests
